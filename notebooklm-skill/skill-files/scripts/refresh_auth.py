...
# Resolve paths — notebooklm-py >=0.4 stores per-profile state under profiles/<name>/
NOTEBOOKLM_HOME = Path(os.environ.get("NOTEBOOKLM_HOME", Path.home() / ".notebooklm"))
PROFILE_NAME = os.environ.get("NOTEBOOKLM_PROFILE", "default")
PROFILE_DIR = NOTEBOOKLM_HOME / "profiles" / PROFILE_NAME
