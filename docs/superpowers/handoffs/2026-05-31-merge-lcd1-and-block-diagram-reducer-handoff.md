...
**Primary source to read first:** `block-diagram-reducer/ANTIGRAVITY-QUESTIONNAIRE.md` — the builder
...
1. Read `block-diagram-reducer/ANTIGRAVITY-QUESTIONNAIRE.md` fully; clone & run **both** apps.
...
*Primary sources: this handoff + `ANTIGRAVITY-QUESTIONNAIRE.md` (BDR, from its builder) + the
