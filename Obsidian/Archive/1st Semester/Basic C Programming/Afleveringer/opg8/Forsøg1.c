...
int main() {
    ...
    int count = readDatabase("database.txt", people);
    Person newPerson; // Declare newPerson here

    // Example of adding a new person
    printf("Indtast fornavn:\n");
    scanf("%49s", newPerson.firstname); // Read first name

    printf("Indtast efternavn:\n");
    scanf("%49s", newPerson.lastname); // Read last name

    printf("Indtast telefonnummer:\n");
    scanf("%14s", newPerson.phone); // Read phone number
