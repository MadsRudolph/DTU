...
🔗 Related: [[TL-Fundamentals]] — $\beta$ and $\alpha$ are the same parameters used in the propagation constant $\gamma = \alpha + j\beta$.  
...
🔗 Related: [[TL-Single-Terminated]] — standing wave positions depend directly on $\beta$ and $\lambda$.  
