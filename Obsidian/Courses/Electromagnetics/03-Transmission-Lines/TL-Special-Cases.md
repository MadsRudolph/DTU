...
🔗 Related: [[TL-Single-Terminated]] — this is a refinement of the general input impedance formulas for the special case of a **lossless line**.  
...
🔗 Related: [[TL-Fundamentals]] — relies on $Z_0$ and $\beta$ from TL fundamentals.  
...
🔗 Related: [[TL-Fundamentals]] — stubs are a practical application of the general $Z_A$ formula.  
...
🔗 Related: [[TL-Single-Terminated]] — this sheet is the extension of general TL termination formulas into **special, practically important cases**.
---
