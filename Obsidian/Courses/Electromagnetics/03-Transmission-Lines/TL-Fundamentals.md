...
🔗 Related: [[TL-Single-Terminated]] — $\gamma$ determines how reflections decay or shift phase in a terminated line.  
...
🔗 Related: [[TL-Single-Terminated]] — $Z_0$ is used directly in the reflection coefficient and input impedance formulas.  
