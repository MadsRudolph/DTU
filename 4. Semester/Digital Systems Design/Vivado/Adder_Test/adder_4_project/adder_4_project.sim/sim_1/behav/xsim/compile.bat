...
REM
REM Generated by Vivado on Fri Feb 06 09:26:06 +0100 2026
...
echo "xvhdl --incr --relax -prj tb_adder_4_top_vhdl.prj"
call xvhdl  --incr --relax -prj tb_adder_4_top_vhdl.prj -log xvhdl.log
